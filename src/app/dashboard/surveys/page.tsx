...
//       setSurveys(temp);
//       setSurveyData(temp.surveys.reverse());
//       setFilteredSurveys(temp.surveys.reverse());
...
//         seeResponses ? responses : filteredResponses?.splice(0, 3)
//       );
//     };
//     filterResponses();
//   }, [seeResponses]);
...
//     const fiterSurveys = () => {
//       setFilteredSurveys(
//         seeSurveys ? surveyData : filteredSurveys?.splice(0, 5)
//       );
//     };
//     fiterSurveys();
//   }, [seeSurveys]);
...
//         sentToEmails,
//         category,
//         questions, // Include custom questions
//       };
...
//       stat: "4.5%",
//       trend: "up",
//       value: surveys?.surveys?.length || 0, // Fallback to 0 if undefined
...
//       stat: "1.2%",
//       trend: "down",
//       value: surveys?.totalCompletedSurveys || 0,
//       trendText: "vs last month",
//       color: "text-red-500",
//     },
//     {
...
//       stat: "1.2%",
//       trend: "down",
//       value: surveys?.totalSeenSurveys || 0,
//       trendText: "vs last month",
//       color: "text-red-500",
//     },
//   ];
