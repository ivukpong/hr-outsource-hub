          ...
          <div>
            <div className="grid grid-cols-1 gap-4 text-white md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              ...
              <div className="p-5 flex h-[130px] flex-col justify-around bg-[#377DFF] rounded-lg md:h-[100px] lg:h-[130px] xl:h-[150px]">
                ...
                <h2 className="text-xl font-bold">{stats?.totalDepartments}</h2>
                <div className="flex gap-2 items-center">
                  <div className="w-[24px] h-[24px] rounded-full flex items-center justify-center bg-[#FFFFFF4D] ">
                    <FaArrowTrendDown />
                  </div>
            ...
            <div className="flex w-full items-center justify-between mb-10 pl-2">
              <h2 className="text-xl font-bold">Department Performace Chart</h2>
            </div>
          </div>
        )}
        <DepartmentChart />
